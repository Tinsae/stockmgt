...
echo 'window.alert("Material Successfully Assigned");';
echo '</script>';}
else
{
echo '<script language="javascript">';
echo 'alert("Unable to Assign Material")';
echo '</script>';
}
}
?>
...
<div class="container">
 ...
 <br/>
  ...
  <div class="sidebar1">
    <ul class="nav">
      <li><a href="newsubstore.php">New Sub Store</a></li>
...
<li><a href="viewassignedmats.php">View Assigned Materials.</a></li>
  ...
  <p align="left"><strong>Assign Material to Sub Store</strong></p>
...
<table width="410" border="0" align="right" cellpadding="2" cellspacing="8">
      <tr>
        ...
        <td width="231">
           <input type="text" name="substoreid" id="substoreid" />
        </td>
      </tr>
      <tr>
        <td>Material ID</td>
