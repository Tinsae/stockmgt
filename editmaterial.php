...
<li><a href="viewassignedmats.php">View Assigned Materials.</a></li>
  ...
  <p align="left"><strong>Edit Material</strong></p>
  <div class="content"><!-- end .content -->
    ...
    <table width="410" border="0" align="right" cellpadding="2" cellspacing="8">
      <tr>
        ...
        <td width="231">
          <input type="text" readonly="readonly"  name="matid" id="matid" value="<?php echo $_GET['matid'];?>" />
        </td>
      </tr>
      <tr>
        <td>Material Name</td>
        <td><input type="text" name="matname" id="matname" value="<?php echo $_GET['matname'];?>"/></td>
      </tr>
      <tr>
        <td>Material Type</td>
        <td><input type="text" name="mattype" id="mattype" value="<?php echo $_GET['mattype'];?>"/></td>
      </tr>
      <tr>
        <td>Unit Price</td>
        <td><input type="text" name="unitprice" id="unitprice" value="<?php echo $_GET['unitprice'];?>"/>birr </td>
      </tr>
      <tr>
      
        <td>Quantity</td>
        <td><input type="text" name="quantity" id="quantity" value="<?php echo $_GET['quantity'];?>"/></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
