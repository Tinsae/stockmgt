...
<li><a href="viewassignedmats.php">View Assigned Materials.</a></li>
  ...
  <p align="left"><strong>View Substores </strong></p>
...
<table style="font-size:12px" border="0" align="center" cellpadding="2"
			...
			<tr>
				...
				<th bgcolor="lightblue">Department</th>
...
echo "<td>".$query2['block']."</td>";

echo "<td><a href='editsubstore.php?substoreid=".$query2['sub_store_ID']."&department=".$query2['department']."&block=".$query2['block']."'>Edit</a></td>";
echo "<td><a href='deletesubstore.php?substoreid=".$query2['sub_store_ID']."'>Delete</a></td><tr>";
}
?>
</ol>
</table> 
