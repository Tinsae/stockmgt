...
echo 'window.alert("New Material Added");';
echo '</script>';}
else
{
echo '<script language="javascript">';
echo 'alert("Unable to Insert Material")';
echo '</script>';
...
<li><a href="viewassignedmats.php">View Assigned Materials.</a></li>
  ...
  <p align="left"><strong>	New Material</strong></p>
  <div class="content"><!-- end .content -->
    ...
    <table width="410" border="0" align="right" cellpadding="2" cellspacing="8">
      <tr>
        ...
        <td width="231">
          <input type="text" name="matid" id="matid" />
        </td>
      </tr>
      <tr>
        <td>Material Name</td>
        <td><input type="text" name="matname" id="matname" /></td>
      </tr>
      <tr>
        <td>Material Type</td>
        <td><input type="text" name="mattype" id="mattype" /></td>
      </tr>
      <tr>
        <td>Unit Price</td>
        <td><input type="text" name="unitprice" id="unitprice" />birr</td>
      </tr>
      <tr>
