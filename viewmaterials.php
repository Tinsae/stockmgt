...
<li><a href="viewassignedmats.php">View Assigned Materials.</a></li>
  ...
  <p align="left"><strong>View Materials</strong></p>
...
<table style="font-size:12px" border="0" align="center" cellpadding="2"
			...
			<tr>
				...
				<th bgcolor="lightblue">Unit Price</th>
                <th bgcolor="lightblue">Quantity</th>

			</tr>
<?php
include('connect.php');
$query1=mysqli_query($dbConn, "SELECT * FROM material");
while($query2=mysqli_fetch_array($query1))	
{	
echo "<tr><td>".$query2['mat_ID']."</td>";
echo "<td>".$query2['mat_name']."</td>";
echo "<td>".$query2['mat_type']."</td>";
echo "<td>".$query2['unit_price']."</td>";
echo "<td>".$query2['quantity']."</td>";

echo "<td><a href='editmaterial.php?matid=".$query2['mat_ID']."&matname=".$query2['mat_name']."&mattype=".$query2['mat_type']."&unitprice=".$query2['unit_price']."&quantity=".$query2['quantity']."'>Edit</a></td>";
echo "<td><a href='deletematerial.php?matid=".$query2['mat_ID']."'>Delete</a></td><tr>";
}
?>
</ol>
</table> 
