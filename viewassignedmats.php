...
<li><a href="viewassignedmats.php">View Assigned Materials.</a></li>
  ...
  <p align="left"><strong>View Assigned Materials </strong></p>
...
<table style="font-size:12px" border="0" align="center" cellpadding="2"
			...
			<!-- column headers -->
			<tr>
				<th bgcolor="lightblue">Sub_Store ID</th>
				<th bgcolor="lightblue">Material ID</th>
				<th bgcolor="lightblue">Assigned Quantity</th>
				<th bgcolor="lightblue">Assigned Date</th>


			</tr>
<?php
include('connect.php');
$query1=mysqli_query($dbConn, "SELECT * FROM assignmaterial");
while($query2=mysql_fetch_array($query1))	
{	
echo "<tr><td>".$query2['sub_store_ID']."</td>";
echo "<td>".$query2['mat_ID']."</td>";
echo "<td>".$query2['assign_qua']."</td>";
echo "<td>".$query2['assign_date']."</td>";


echo "<td><a href='editassignedmats.php?substoreid=".$query2['sub_store_ID']."&matid=".$query2['mat_ID']."&assignqua=".$query2['assign_qua']."&assigndate=".$query2['assign_date']."'>Edit</a></td>";
echo "<td><a href='deleteassignedmats.php?substoreid=".$query2['sub_store_ID']."&matid=".$query2['mat_ID']."'>Delete</a></td><tr>";
}
?>
</ol>
</table> 
