...
<li><a href="viewassignedmats.php">View Assigned Materials.</a></li>
  ...
  <p align="left"><strong>Edit Sub-Store </strong></p>
  <div class="content"><!-- end .content -->
    ...
    <table width="410" border="0" align="right" cellpadding="2" cellspacing="8">
      ...
      <tr>
        <td> Department</td>
        <td><input type="text" name="department" id="department" value="<?php echo $_GET['department'];?>"/></td>
      </tr>
      <tr>
        <td>Block</td>
        <td><input type="text" name="block" id="block" value="<?php echo $_GET['block'];?>"/></td>
      </tr>
